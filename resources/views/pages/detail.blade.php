                ...
                <div class="row">
                    <div class="col-lg-8 pl-lg-0">
                        <div class="card card-details">
                            ...
                            @if ($item->galleries->count())
                                <div class="gallery">
                                    <div class="xzoom-container " width="100px">
                    ...
                    <div class="col-lg-4">
                            ...
                            <table class="trip-informations">
                                <tr>
                                    ...
                                    <td width="50%" class="text-right">
                                        {{ \Carbon\Carbon::create($item->departure_date) }}</td>
                                </tr>
                                <tr>
                        ...
                        <div class="join-container">
                            ...
                            @endauth
                            @guest
                                <a href="{{ url('login') }}" class="btn btn-block btn-join-now mt-3 py-2">Login or Register
                                    to join</a>
                            @endguest
                        </div>
                    </div>
